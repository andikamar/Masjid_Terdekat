...
import net.dika.masjid.activity.ShowPlacesOnMapActivity;
import net.dika.masjid.adapter.PlaceRecyclerViewAdapter;
...
public class NearByFragment extends Fragment {
    ...
    double lat = 0;
    double lng = 0;
    private String placeType = "mosque";
    ...
    private String buildUrl(double latitude, double longitude, String API_KEY) {
        ...
        urlString.append("&radius=1000"); // places between 1 kilometer
        urlString.append("&types=" + placeType.toLowerCase());
        urlString.append("&zoom=10");
    ...
    private void getNearbyPlaces() {
        ...
        if (lat != 0 && lng != 0) {
            ...
            String apiKey = getContext().getResources().getString(R.string.api_server);
