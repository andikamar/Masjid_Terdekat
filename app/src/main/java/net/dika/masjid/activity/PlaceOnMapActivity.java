...
import net.dika.masjid.DirectionsJSONParser;
import net.dika.masjid.R;
import net.dika.masjid.models.Location;
...
public class PlaceOnMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void showDistance() {
        ...
        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(destinationPosition, 10));
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String parameters = str_origin + "&" + str_dest + "&" + sensor + "&key=" + this.getResources().getString(R.string.api_server);
